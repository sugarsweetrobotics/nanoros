...
namespace msgparser {
	...
	inline bool is_primitive_typename(const std::string& typeName) {
		if (typeName == "bool") return true;
		if (typeName == "int8") return true;
		if (typeName == "char") return true;
		if (typeName == "uint8") return true;
		if (typeName == "byte") return true;
		if (typeName == "int16") return true;;
		if (typeName == "uint16") return true;
		if (typeName == "int32") return true;
		if (typeName == "uint32") return true;
		if (typeName == "int64") return true;
		if (typeName == "uint64") return true;
		if (typeName == "float32") return true;
		if (typeName == "float64") return true;
