...
namespace ssr {
    namespace nanoros {
        ...
        public:
            ...
            virtual std::shared_ptr<const ROSSrvResponse> call(const std::shared_ptr<ROSSrvPacker>& stub, const std::shared_ptr<const ROSSrvRequest>& arg, const double timeout=1.0) { return nullptr; }
        };
